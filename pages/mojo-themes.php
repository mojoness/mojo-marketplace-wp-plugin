				...
				<div class="panel-heading">
					<div class="row">
						<div class="col-xs-12 col-sm-8">
							<ol class="breadcrumb">
								<li><?php esc_html_e( 'WordPress Themes' ); ?></li>
								<?php
								if ( isset( $_GET['items'] ) ) {
									?>
