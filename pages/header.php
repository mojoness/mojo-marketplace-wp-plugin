				...
				<div class="inner-holder">
					...
					<div class="menu-holder dropdown pull-right">
						<button type="button" class="dropdown-toggle visible navbar-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							<span class="visible-xs-inline-block visible-sm-inline-block"><?php esc_html_e( 'Account' ); ?></span>
							<span class="sr-only"><?php esc_html_e( 'Toggle menu' ); ?></span>
							<span class="icon-bar hidden-sm hidden-xs"></span>
							<span class="icon-bar hidden-sm hidden-xs"></span>
							<span class="icon-bar hidden-sm hidden-xs"></span>
						</button>
						<?php if ( 'default' != mm_brand() ) { ?>
						<span class="powered"><?php esc_html_e( 'Powered By' ); ?> <a href="<?php echo mm_build_link( 'https://www.mojomarketplace.com', array( 'utm_content' => 'powered_by_link' ) ); ?>" target="_blank"><img height="16" width="156" alt="Mojo Marketplace" src="<?php echo mm_brand( MM_ASSETS_URL . 'img/logo.svg' ); ?>"></a></span>
						<?php } ?>
						<div class="dropdown-menu">
							...
							<ul class="projects-nav list-unstyled">
								<li><a href="<?php echo add_query_arg( array( 'page' => 'mojo-purchases' ), admin_url( 'admin.php' ) ); ?>"><?php esc_html_e( 'Purchases' ); ?></a></li>
							</ul>
						</div>
					</div>
					<?php } ?>
					<div class="header-holder clearfix">
						...
						<form class="navbar-form form-inline navbar-right text-right" role="search" action="admin.php" method="GET">
							<div class="form-group">
								...
								<input name="search" type="text" class="form-control input-lg" placeholder="<?php esc_attr_e( 'Search Themes, Plugins, &amp; Services' ); ?>">
							</div>
							<button type="submit" class="btn btn-info btn-lg"><?php esc_html_e( 'Search' ); ?></button>
						</form>
					</div>
				</div>
			</div>
