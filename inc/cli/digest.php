...
class Bluehost_CLI_Digest extends EIG_WP_CLI_Command {
	...
	protected function eig_digest_options_transients_cron() {
		$details = array();
		ob_start();
			WP_CLI::run_command( array( 'option', 'list' ), array( 'fields' => 'option_name,autoload,size_bytes', 'format' => 'json' ) );
