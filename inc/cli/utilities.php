...
abstract class EIG_WP_CLI_Command extends WP_CLI_Command {
	protected function bluehost_logo() {
		ob_start();
		?>

		___  _    _  _ ____ _  _ ____ ____ ___
		|__] |    |  | |___ |__| |  | [__   |
	 ...
	 */
	protected function clrline( $label = '', $background = '', $text_color = '%_', $emoji_prefix = '' ) {
		if ( ! empty( $background ) ) {
